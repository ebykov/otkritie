...
var Special = function (_BaseSpecial) {
  ...
  _createClass(Special, [{
    ...
    value: function createElements() {
      ...
      EL.bcMatch = (0, _dom.makeElement)('div', CSS.main + '-card__match', {
        innerHTML: '' + _svg2.default.match
      });
    ...
    value: function _continue() {
      ...
      (0, _animate.animate)(EL.cardWrapper, animationClassName).then(function () {
        ...
        if (EL.bcHead.contains(EL.bcMatch)) {
          EL.bcHead.removeChild(EL.bcMatch);
        }
    ...
    value: function makeAnswer(question, type) {
      ...
      if (question.correct === type) {
        ...
        EL.bcHead.appendChild(EL.bcMatch);
      } else {
